...
<div class="card">
      <div class="hed">
         ...
         <input type="text" placeholder ="First name" class="txtbox" id="fname" name="fname" onblur="IsfName()"></br>
            ...
            <input type="text" placeholder ="Last name" class="txtbox" id="lname" name="lname" onblur="IslName()"></br>
            <span id = "lnameSpan" style="color:red"></span>
             <input type="email" placeholder ="Email" class="txtbox" id="email" name="email" onblur="IsEmail()"></br>
             <span id = "emailSpan" style="color:red"></span>  
             <input type="password" placeholder ="Password"id="password" class="txtbox" name="password" onblur="IsPassword()"></br>
             <span id = "pwdSpan"  style="color:red"></span>
             <input type="password" placeholder ="Retype password" class="txtbox" id="cpassword" name="cpassword" onblur="isCompare()"></br>
