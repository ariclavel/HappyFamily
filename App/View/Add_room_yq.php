<<<<<<< Updated upstream:Add_room_yq.php
<?php
...
if (ISSET($_POST['submit']))
  {
    ...
    $roomName=clean($_POST['room_name']);
    $roomNumber = clean($_POST['room_number']);
    $result =addroom($db,$roomName,$roomNumber,$regid);
     ...
     if($result)
     {
       ...
       header("Location: Add_room_ayq.php");
     }
     else
     {
       $_SESSION['message'] = "<div class='alert alert-info'>NOT ADDED</div>";
...
<form method="POST" enctype="multipart/form-data">
         ...
         <tr>
               <th><h4 class="text-right">ADD ROOM</h4></th>
                ...
                <tr>
                            <td>
                            <input type="text" placeholder ="Room number" class="form-control"  name="room_number" id="rnum" onblur="IsNum()"><br>
                            <span id = "rnumSpan" style="color:red"></span>  
                            </td>
                </tr>
...
>>>>>>> Stashed changes:App/View/Add_room_ayq.php
</html>