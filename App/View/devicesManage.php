        ...
        <div class="main-body">
            ...
            <div class="promo_card">
              <form action = "../Model/addDevice.php" method="POST">
                  <input type="hidden" placeholder ="Enter new Device name" class="form-control" id="user" name="user" value = {$user} ></br>
                  <input type="text" placeholder ="Enter Device name" class="form-control" id="sname" name="sname"></br>
                  <input type="text" placeholder ="Enter Device mode" class="form-control" id="mode" name="mode"></br>
                  <input type="text" placeholder ="Enter description optional" class="form-control" id="ds" name="ds"></br>
